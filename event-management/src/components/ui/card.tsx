...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            "bg-card text-card-foreground border-2 border-black p-0 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn("flex flex-col space-y-1.5 p-8 border-b-2 border-black", className)}
        {...props}
    />
))
